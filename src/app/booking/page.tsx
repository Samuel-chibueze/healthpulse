...
export default function BookingPage() {
  return (
    <div className='flex flex-col px-2 md:px-56 justify-center items-center h-screen bg-gray-100 '>
      <div className='w-full h-[70vh] flex flex-col justify-start gap-7 rounded-md py-8 items-center px-6 shadow-xl'>
        ...
        <Link href={'/labs'}>
          <div className='rounded-md bg-gradient-to-r from-purple-700 via-purple-9500 to-purple-950 shadow-lg h-[15vh] md:w-[40vw] w-[80vw] flex justify-between items-center px-8 transform transition-transform hover:scale-105'>
            ...
            <Image src={Image1} height={70} width={80} alt='doctor image' className='rounded-full border-2 border-white shadow-md' />          </div>
        </Link>
