...
const home_section_1 = () => {
    ...
    return <div className='md:flex  gap-10  bg-white'>
        <div className='md:w-[50vw] text-center  md:my-10 lg:px-[100px]'>
            <h1 className='w-full text-4xl md:text-5xl md:w-[30vw] text-[#A68DAD] font-semibold pt-20 md:pt-0'>Dollar investments that help you grow</h1>
